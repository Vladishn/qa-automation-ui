...
def test_parse_live_button_logs_detects_all_phases() -> None:
    ...
    12-08 11:01:00.500 I/QA_LIVE: SESSION=QS_TEST PHASE2_START expected=50
    ...
    12-08 11:02:00.500 I/QA_LIVE: SESSION=QS_TEST PHASE3_START expected=50
    12-08 11:02:10.500 I/QA_LIVE: SESSION=QS_TEST PHASE3_DEVICE_READY expected_channel=50
    ...
    12-08 11:02:12.300 I/QA_LIVE: SESSION=QS_TEST CHANNEL_SET_RESULT expected=50 observed=50 ok=true
    """
    signals = parse_live_button_logs(log_text, expected_channel=50, session_id="QS_TEST")
